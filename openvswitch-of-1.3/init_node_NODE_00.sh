...
echo "4. configure an interface for vlan 10"
sudo vconfig add eth1 10
sudo ifconfig eth1.10 192.168.10.1/24 up
	
echo "5. configure an interface for vlan 20"
sudo vconfig add eth1 20
sudo ifconfig eth1.20 192.168.20.1/24 up
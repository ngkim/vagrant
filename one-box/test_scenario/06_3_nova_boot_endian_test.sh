...
# red-net-port
create_port_in_provider_net $RED_NET $RED_SBNET $RED_NETWORK_IP_TEST
RED_PORT_ID=$_PORT_ID

# green-net-port
create_port_in_provider_net $GRN_NET $GRN_SBNET $GRN_NETWORK_IP_TEST
GRN_PORT_ID=$_PORT_ID

# orange-net-port
create_port_in_provider_net $ORG_NET $ORG_SBNET $ORG_NETWORK_IP_TEST
...
do_nova_boot vUTM_Test $UTM_IMAGE

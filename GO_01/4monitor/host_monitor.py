...
class CloudMonitor():
    def __init__(self):
        ...
        self.dedi_cnode_component['nova']=['nova-compute','nova-api-metadata']
        self.dedi_cnode_component['neutron']=['neutron-openvswitch-agent','neutron-metadata-agent','neutron-ns-metadata-proxy']
    ...
    def run(self):
        ...
        #self.rssh.register('east-ctrl',    '211.224.204.144', 22, 'root', 'ohhberry3333' )
        #self.rssh.register('east-cnode01', '211.224.204.147', 22, 'root', 'ohhberry3333' )
        #self.rssh.register('east-cnode02', '211.224.204.146', 22, 'root', 'ohhberry3333' )
        #self.rssh.register('east-cnode03', '211.224.204.141', 22, 'root', 'ohhberry3333' )
        ...
        while True:
            ...
            try:
                ...
                #self.check_allinone_openstack_component('east-ctrl')
                #self.check_dedi_cnode_openstack_component('west-cnode02')
                #return

                self.check_openstack_component_cli('east-ctrl')
                self.check_openstack_component_cli('east-cnode01')
                self.check_openstack_component_cli('east-cnode02')
                self.check_openstack_component_cli('east-cnode03')

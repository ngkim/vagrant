...
function make_utm_ha_test_vms() {
    
    customer=$1
    
    utm_mgmt_ip="10.0.0.${mgmt_base}"
    green_mgmt_ip="10.0.0.${mgmt_base}"
    orange_mgmt_ip="10.0.0.${mgmt_base}"
    ...
    make_user_green_vm_with_fixed_ip ${customer}_client $SERVER_IMAGE \
        ...
        $AVAILABILITY_ZONE $CNODE03 $green_bootstrap_file
    ...
    make_user_orange_vm_with_fixed_ip ${customer}_server $SERVER_IMAGE \
        ...
        $AVAILABILITY_ZONE $CNODE03 $orange_bootstrap_file
    ...
    make_user_utm_vm_with_fixed_ip ${customer}_utm_s $SERVER_IMAGE \
        $utm_mgmt_ip  global_mgmt_net global_mgmt_subnet \
        $utm_green_ip  $GREEN_NET $GREEN_SUBNET \
        $utm_orange_ip $ORANGE_NET $ORANGE_SUBNET \

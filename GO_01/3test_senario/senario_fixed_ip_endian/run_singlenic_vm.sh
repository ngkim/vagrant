...
source ./5make_multinic_vm_with_floating_ip_for_mgmt.sh
    ...
    make_user_singlenic_utm_vm ${customer}_singlenic_utm $UTM_IMAGE \
        global_mgmt_net $AVAILABILITY_ZONE $CNODE01
    
    allocate_floating_ip_to_mgmt_vm ${customer}_singlenic_utm
